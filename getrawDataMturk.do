texdoc init getrawDataMturk.tex, logdir(getrawDataMturklogfiles) replace
...
clear all
import delimited ///
	"raw/USDAmTurk2018 Klaas_July 17, 2018_10.22.csv", clear ///
...
set more off
! /Library/TeX/Distributions/.DefaultTeX/Contents/Programs/texbin/pdflatex getrawDataMturk
